...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] overflow-hidden flex flex-col items-center justify-center bg-warm-50">
      ...
      {/* Main Content */}
      <div className="flex flex-col justify-center items-center w-[280px] sm:w-[360px] md:w-[600px] lg:w-[800px] z-50 pointer-events-auto px-4">
        <motion.p
        ...
        <div className="flex flex-col sm:flex-row justify-center space-x-0 sm:space-x-4 items-center mt-8 sm:mt-12 gap-4 sm:gap-0">
          <motion.a
            href="/booking"

...
const testCredentials = [
	{
		...
		bgColor: "bg-terracotta-50 hover:bg-terracotta-100",
	...
	},
	{
		...
		icon: Users,
		color: "text-warm-600",
		bgColor: "bg-warm-100 hover:bg-warm-200",
	...
	return (
		<div className="space-y-3 mt-5">
			<div className="text-center">
				<p className="text-sm font-medium text-warm-600 mb-3">Quick Login (Demo)</p>
			</div>

...
async function ensureReferralCode(userId, email) {
    ...
    if (!referralCode) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].update(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["users"]).set({
            referralCode
        }).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$drizzle$2d$orm$40$0$2e$45$2e$2_$40$prisma$2b$client$40$6$2e$19$2e$2_$40$types$2b$better$2d$sqlite3$40$7$2e$6$2e$13_better$2d$sqlite3$40$12$2e$8$2e$0_prisma$40$6$2e$19$2e$2$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["users"].id, userId)).run();
    }
    ...
    if (!existingCode) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["referralCodes"]).values({
            id: crypto.randomUUID(),
            code: referralCode,
            userId: user.id,
...
"[project]/app/api/v1/user/referral/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const referralCode = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$referral$2d$code$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureReferralCode"])(user.id, user.email);
        // Get referral statistics
        let referralCodeRecord;
        try {
            referralCodeRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].query.referralCodes.findFirst({
                where: {
                    code: referralCode
                }
            });
        ...
        let referralRewards = [];
        try {
            referralRewards = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].query.referralRewards.findMany({
                where: {
                    referrerId: user.id
                }
            });
        ...
        try {
            ...
            if (session?.user?.email) {
                ...
                if (user) {
                    const code = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$referral$2d$code$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureReferralCode"])(user.id, user.email);
                    const appUrl = process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3000";
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$1_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        code,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89942f0c._.js.map
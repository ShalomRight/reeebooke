...
"[project]/app/api/v1/admin/referrals/generate-all/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST() {
    try {
        ...
        const usersWithoutCodes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].query.users.findMany({
        ...
        for (const user of usersWithoutCodes){
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$referral$2d$code$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureReferralCode"])(user.id, user.email);
                results.generated++;
            } catch (error) {
                results.failed++;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45a9425f._.js.map
...
"[project]/lib/square-calendar-mock-data/events.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/square-calendar-store/calendar-store.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$square$2d$calendar$2d$mock$2d$data$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/square-calendar-mock-data/events.ts [app-ssr] (ecmascript)");
;
;
;
const BASE_WEEK_START = new Date("2024-02-04");
function getDayOfWeek(date) {
    const day = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$getDay$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDay"])(date);
    return day === 0 ? 6 : day - 1;
}
function getEventsForWeek(startDate, allEvents) {
    const weekEvents = [];
    for(let i = 0; i < 7; i++){
        const currentDay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$addDays$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDays"])(startDate, i);
        ...
        allEvents.forEach((event)=>{
            ...
            if (eventDayOfWeek === currentDayOfWeek) {
                const eventDateStr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(currentDay, "yyyy-MM-dd");
                weekEvents.push({
                    ...event,
...
const useCalendarStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$12_$40$types$2b$react$40$19$2e$2$2e$14_react$40$19$2e$2$2e$4$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        events: [],
        setEvents: (events)=>set({
                events
            }),
        currentWeekStart: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$startOfWeek$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfWeek"])(new Date(), {
            weekStartsOn: 1
        }),
        searchQuery: "",
        eventTypeFilter: "all",
        ...
        goToNextWeek: ()=>set((state)=>({
                    currentWeekStart: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$addWeeks$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addWeeks"])(state.currentWeekStart, 1)
                })),
        goToPreviousWeek: ()=>set((state)=>({
                    currentWeekStart: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$subWeeks$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subWeeks"])(state.currentWeekStart, 1)
                })),
        goToToday: ()=>set({
                currentWeekStart: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$startOfWeek$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfWeek"])(new Date(), {
                    weekStartsOn: 1
        ...
        goToDate: (date)=>set({
                currentWeekStart: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$startOfWeek$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfWeek"])(date, {
                    weekStartsOn: 1
                })
            }),
        ...
        addEvent: (event)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$square$2d$calendar$2d$mock$2d$data$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addEvent"])(event);
        },
        ...
        getWeekDays: ()=>{
            ...
            const days = [];
            for(let i = 0; i < 7; i++){
                days.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$addDays$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDays"])(state.currentWeekStart, i));
            }
            return days;
        }
    }));
...
//# sourceMappingURL=lib_58220c4b._.js.map
...
"[project]/app/api/v1/cart/sync/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const existingCartItems = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].query.carts.findMany({
            where: {
                userId: user.id
            }
        });
        const existingItemsSet = new Set(existingCartItems.map((item)=>`${item.serviceId}-${normalizeDate(item.date)}-${item.time}`));
        ...
        let itemsToAdd = Array.from(uniqueGuestItems.values()).filter((item)=>!existingItemsSet.has(`${item.serviceId}-${normalizeDate(item.date)}-${item.time}`));
        ...
        for (const item of itemsToAdd){
            try {
                ...
                const exists = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].query.carts.findFirst({
                    where: {
                        userId: user.id,
        ...
        // Fetch updated cart
        const updatedCart = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].query.carts.findMany({
            where: {
                userId: user.id
            },
            with: {
        ...
        if (itemsToDelete.length > 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].delete(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["carts"]).where({
                where: {
                    id: {
                        in: itemsToDelete
                    }
        ...
        const finalCart = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].query.carts.findMany({
            where: {
                userId: user.id
            },
            with: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__872e97b9._.js.map
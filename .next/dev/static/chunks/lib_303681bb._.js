...
"[project]/lib/currentUserClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function currentUserClient() {
    ...
    // cast role safely
    const role = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rbac$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeRole"])(session.user.role);
    return {
        ...session.user,
        role,
...
_s(currentUserClient, "ujwIunAD3hlHFoJLG3BNiDLiMqM=", false, function() {
    return [
...
//# sourceMappingURL=lib_303681bb._.js.map